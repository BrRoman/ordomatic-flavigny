...
def dict_sancto_create(current_year, even_year, year_letter, dict_tempo, paques, nb_dim_ap_pentec):
    ...
    if toussaint_date.weekday() == 4:
        dict_tempo[toussaint_date]["symbols"] = dict_tempo[presentation_date]["symbols"].replace(" µ", " ł")
        dict_tempo[toussaint_date + datetime.timedelta(days = 1)]["symbols"] = " µ" + dict_tempo[presentation_date + datetime.timedelta(days = 1)]["symbols"]
    ...
    if comm_defunts_date.weekday() == 4:
        dict_tempo[comm_defunts_date]["symbols"] = dict_tempo[presentation_date]["symbols"].replace(" µ", " ł")
        dict_tempo[comm_defunts_date + datetime.timedelta(days = 1)]["symbols"] = " µ" + dict_tempo[presentation_date + datetime.timedelta(days = 1)]["symbols"]
