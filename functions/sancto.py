...
def dict_sancto_create(current_year, even_year, year_letter, dict_tempo, paques, nb_dim_ap_pentec):
    ...
    presentation["body"] = "\n\\item in MC: ante Missam conventualem peragitur benedictio ac processio candelarum. Post processionem cantantur introitus Missæ et psalmodia Tertiæ ;" + aspersion + " lectiones propriæ:" + lectures_mc + " / Lc \\textbf{2}, 22-40 ; præfatio propria." + vepres + "\n\\item post Completorium dicitur ø \\textit{Ave Regina Cælorum}."
    # Si 1er vendredi du mois, reporter le jeûne au lendemain:
    ...
    if is_careme(saint_polycarpe_date):
        ...
        saint_polycarpe["body"] = "\n\\item ad Laudes: pro commemoratione S. Polycarpi ø \\textit{Qui odit} (AM 642) ; oratio : olim die 26 ianuarii vel in suppl. 110.\n\\item in MC: collecta de sancto." 
    else:
    ...
    saint_ephrem["header"] = " - S. Epræm, diaconi et Ecclesiæ doctoris - \\textit{memoria minor} - " + couleur + " (olim die 18 iunii)."
