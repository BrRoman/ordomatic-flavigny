...
def dict_tempo_create(current_year, even_year, year_letter):
    ...
    lectures_mc = "Sir \\textbf{24}, 1-4.12-16 / Eph \\textbf{1}, 3-6.15-18 / Io \\textbf{1}, 1-18"
    ...
    for i in range((bapteme_date - noel_date).days + 6):
        ...
        if new_day_date != dim_2_ap_noel_date and new_day_date != bapteme_date:
            ...
            if new_day_date.day == 7 and new_day_date.weekday() != 6:
                ...
                vigiles_ap_epiph = "\n\\item ad Vigilias: lectio \\textit{Veritatem} de epistola ad Romanos (pro breviario vetere in supplemento 36)"
    ...
    lectiones_fd = {"A": "Deut \\textbf{8}, 2-3.14b-16a / 1 Cor \\textbf{10}, 16-17 / Io \\textbf{6}, 51-59", "B": "Ex \\textbf{24}, 3-8 / Hebr \\textbf{9}, 11-15 / Mc \\textbf{14}, 12-16.22-26", "C": "Gen \\textbf{14}, 18-20 / 1 Cor \\textbf{11}, 23-26 / Lc \\textbf{9}, 11b-17"}
    ...
    lectiones_sc = {"A": "Deut \\textbf{7}, 6-11 / 1 Io \\textbf{4}, 7-16 / Mt \\textbf{11}, 25-30", "B": "Os \\textbf{11}, 1b 3-4.8c-9 / Eph \\textbf{3}, 8-12.14-19 / Io \\textbf{19}, 31-37", "C": "Ez \\textbf{34}, 11-16 / Rom \\textbf{5}, 5-11 / Lc \\textbf{15}, 3-7"}
    ...
    for i in range(nb_dim_per_annum_ap_bapteme):
        ...
        if i != 0:
            ...
            new_dim["body"] = comment_septua + "\n\\item in MC: præfatio " + num_pref_dim + " de dominicis." + ("\n\\item ad benedictionem Sanctissimi Sacramenti, post canticum expositionis, cantatur \\textit{Ubi Caritas} in Besnier 275 (hebdomada pro christianorum unitate)." if new_dim_date.day < 25 and new_dim_date.day >= 18 else "")
    ...
    for i in range(nb_dim_ap_pentec):
        ...
        if i != 0:
            if i == 1: # Trinité.
                ...
                trinite_lectiones = {"A": "Ex \\textbf{34}, 4b-6.8-9 / 2 Cor \\textbf{13}, 11-13 / Io \\textbf{3}, 16-18", "B": "Deut \\textbf{4}, 32-34.39-40 / Rom \\textbf{8}, 14-17 / Mt \\textbf{28}, 16-20", "C": "Prov \\textbf{8}, 22-31 / Rom \\textbf{5}, 1-5 / Io \\textbf{16}, 12-15"}
