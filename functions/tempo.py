...
def dict_tempo_create(current_year, even_year, year_letter):
    ...
    for i in range(2):
        ...
        new_dim_adv["body"] = ("\\item ad Vigilias : post lectiones I nocturni, dicitur ¶ lectionis 1 \\textit{Aspiciens a longe}." if i == 0 else "")
    ...
    samedi_saint["II_vesp"] = "\n\\ApplyHeader{ &\\MakeUppercase{\\textbf{Vigilia paschalis}} - \\textit{Alb.}}\n\\ApplyBody{\n\\item celebratio huius Vigiliæ peragenda est nocte.\n\\item in Missa : ad hymnum \\textit{Gloria} pulsantur campanæ ; post Evangelium, renovatio promissionum baptismalium : indulgentia plenaria ; Or. n. 11 ; præfatio paschalis I (\\textit{in hac potissimum nocte}) ; \\textit{Communicantes} et \\textit{Hanc igitur} propria ; \\textit{Ite Missa est} cum duobus \\textit{Alleluia}."
    ...
    pentecote["body"] = "\n\\item Ad Laudes : ß \\textit{Benedicamus Domino} cum duobus \\textit{Alleluia}\n\\item in MC : sequentia ; præfatio et \\textit{Communicantes} propria ; \\textit{Ite Missa est, Alleluia Alleluia} ut in die Paschæ."
